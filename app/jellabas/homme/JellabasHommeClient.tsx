...
import { SlidersHorizontal, X, Shield, Award, Gem } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

interface JellabasHommeClientProps {
  initialProducts: any[];
}

export default function JellabasHommeClient({ initialProducts }: JellabasHommeClientProps) {
  ...
  const styles = [
    'Business', 'Traditionnelle', 'Moderne', 'Sultan', 'Casual', 'Cérémonie'
  ];

  const colors = [
    'Noir', 'Blanc', 'Gris', 'Bleu Marine', 'Beige', 'Marron', 'Vert'
  ];
  ...
  const priceRanges = [
    ...
    { label: 'Moins de 150€', value: '0-150' },
    { label: '150€ - 300€', value: '150-300' },
    { label: '300€ - 600€', value: '300-600' },
    { label: 'Plus de 600€', value: '600+' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="relative h-[400px] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-slate-800 to-blue-900">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-6">
              L'élégance masculine entre tradition et modernité
            </p>
