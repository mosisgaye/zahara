...
import { SlidersHorizontal, X, Shield, Award, Zap } from 'lucide-react';
...
async function fetchShopifyProducts() {
  try {
    const response = await fetch('/api/shopify-storefront', {
      ...
      body: JSON.stringify({
        query: `{
          collectionByHandle(handle: "jellabas-homme") {
            products(first: 50) {
              edges {
                node {
                  id
...
const jellabasHommeProducts = [
  {
    id: 1,
    name: "Jellaba Sultan Brodée Or",
    price: 380,
    originalPrice: 450,
    image: "/images/homme/1.jpeg",
    category: "Collection Prestige",
    rating: 5,
    isNew: true,
    handle: "jellaba-sultan-brodee-or"
  },
  {
    id: 2,
    name: "Jellaba Business Moderne",
    price: 245,
    image: "/images/homme/2.jpeg",
    category: "Business",
    rating: 4.8,
    handle: "jellaba-business-moderne"
  },
  {
    id: 3,
    ...
    price: 195,
    originalPrice: 230,
    image: "/images/homme/3.jpeg",
    category: "Traditionnelle",
    rating: 4.7,
    handle: "jellaba-traditionnelle-blanche"
  },
  {
    id: 4,
    name: "Jellaba Sport Chic",
    price: 165,
    image: "/images/homme/4.jpeg",
    category: "Casual",
    rating: 4.5,
    handle: "jellaba-sport-chic"
  },
  {
    id: 5,
    ...
    price: 320,
    originalPrice: 380,
    image: "/images/homme/5.jpeg",
    category: "Cérémonie",
    rating: 4.9,
    handle: "jellaba-ceremonie-noire"
  },
  {
    id: 6,
    name: "Jellaba Quotidienne Confort",
    price: 135,
    image: "/images/homme/6.jpeg",
    category: "Quotidien",
    rating: 4.4,
  ...
  },
  {
    ...
    price: 520,
    image: "/images/homme/7.jpeg",
    category: "Collection Prestige",
    rating: 5,
    isNew: true,
    handle: "jellaba-luxe-cachemire"
  },
  {
    id: 8,
    ...
    price: 115,
    originalPrice: 140,
    image: "/images/homme/8.jpeg",
    category: "Été",
    rating: 4.6,
    handle: "jellaba-ete-legere"
  }
];
...
const filters = {
  ...
  priceRanges: [
    ...
    { label: "Plus de 450€", min: 450, max: Infinity }
  ],
  sizes: ["S", "M", "L", "XL", "XXL", "3XL", "Sur mesure"],
  colors: ["Blanc", "Noir", "Gris", "Bleu marine", "Beige", "Marron", "Vert"]
};

export default function JellabasHommePage() {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-playfair font-bold mb-6">
                Jellabas Masculines d'Excellence
              </h1>
              <p className="text-lg md:text-xl text-gray-700 max-w-2xl mx-auto">
                Collection prestigieuse de jellabas masculines. Élégance, confort et 
                savoir-faire artisanal pour l'homme moderne.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <span>/</span>
          <span className="text-black font-medium">Collection Homme</span>
        </nav>
      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">Noblesse & Tradition</h3>
              <p className="text-gray-600">Des créations qui incarnent l'élégance masculine marocaine</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Award className="w-8 h-8 text-gold" />
              </div>
              <h3 className="font-semibold text-lg mb-2">Qualité Supérieure</h3>
              <p className="text-gray-600">Tissus nobles et finitions impeccables</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Zap className="w-8 h-8 text-gold" />
              </div>
              <h3 className="font-semibold text-lg mb-2">Style Moderne</h3>
              <p className="text-gray-600">Alliance parfaite entre tradition et modernité</p>
            </div>
          </div>
        </div>
      </section>
